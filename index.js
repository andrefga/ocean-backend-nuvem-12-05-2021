...
const url = 'mongodb+srv://andre:w5ZHh2DAGPdni63u@cluster0.7iacu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';

//const url = 'mongodb://localhost:27017';
// usuario andre
// Senha do MongoDB na web w5ZHh2DAGPdni63u
...
app.get('/hello', function (req, res) {
  res.send('Tudo funcionando perfeito!!!!');
});
